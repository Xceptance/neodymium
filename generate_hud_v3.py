...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Active step is the RUNNING step */
        .step-card.active {
        ...
        .step-card:hover .bp-icon:not(.bp-active) { opacity: 0.3; } /* Show faintly on hover if not active */
        .bp-icon:hover { opacity: 0.8 !important; }
        .bp-icon.bp-active { opacity: 1; text-shadow: 0 0 8px rgba(239, 68, 68, 0.6); }

        /* Toggled Info Accordion */
            ...
            <div class="scrollable-content" id="timelineList">
                ...
                <div class="block-group" id="stepsGroup">
                    ...
                    <div class="step-card include-lvl-1" onclick="toggleAccordion(this)">
                        ...
                        <div class="step-accordion-details">
                            <div class="acc-header">
                                <div class="acc-reasoning"><i class="fa-solid fa-brain"></i> Original selector failed. Identified new checkout button via layout analysis.</div>
                                <div class="acc-duration">
                                    <div><i class="fa-solid fa-brain" style="color: var(--accent-purple);"></i> AI: 1.2s</div>
                                    <div><i class="fa-solid fa-bolt" style="color: var(--accent-warning);"></i> Exec: 0.5s</div>
                                </div>
                            </div>
                            <div class="webdriver-code">driver.findElement(By.id("new-btn-checkout")).click();</div>
                        </div>
                    </div>

                    <!-- Branching IF / ELSE Logic Mock -->
                    <div class="step-card include-lvl-2 optional-step" onclick="toggleAccordion(this)">
                        <div class="step-row">
                            <div class="step-status-icon"><i class="fa-solid fa-circle-check" style="color: var(--accent-success);"></i></div>
                            <div class="step-text-container">
                                <div class="tag-row">
                                ...
                                <div class="step-text">Check if guest checkout modal is present.</div>
                            </div>
                        ...
                        <div class="step-accordion-details">
                            <div class="acc-header">
                                <div class="acc-reasoning"><i class="fa-solid fa-brain"></i> Evaluated condition: Modal is present. Branch taken.</div>
                                <div class="acc-duration">
                                    <div><i class="fa-solid fa-bolt" style="color: var(--accent-warning);"></i> Exec: 0.1s</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="step-card active include-lvl-3" onclick="toggleAccordion(this)">
                        <div class="step-row">
                            ...
                            <div class="step-text-container">
                                <div class="tag-row">
                                    ...
                                    <div class="include-breadcrumb"><i class="fa-solid fa-folder-open"></i> guest-form.yaml</div>
                                </div>
                        ...
                        <div class="step-accordion-details open">
                            <div class="acc-header">
                                ...
                                <!-- Duration hidden for current step as requested -->
                            </div>
                            <img src="https://picsum.photos/800/300?random=1" class="acc-screenshot" alt="Screenshot of guest form">
                            <div class="webdriver-code">driver.findElement(By.id("guest-street")).sendKeys("123 Test Street");</div>
                        </div>
                    </div>
        ...
        <div class="column">
            ...
            <div class="scrollable-content">
                <div style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <img src="https://picsum.photos/600/800?random=2" style="width: 100%; border-radius: 8px; border: 1px solid var(--border-color);" alt="Full page view">
                </div>
            </div>
        </div>
    </div>
