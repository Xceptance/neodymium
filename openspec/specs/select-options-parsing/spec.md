# Select Options Parsing Capability

## Purpose
TBD: Defines how `<select>` elements and their `<option>` children are parsed and represented in the simplified DOM for AI consumption.
