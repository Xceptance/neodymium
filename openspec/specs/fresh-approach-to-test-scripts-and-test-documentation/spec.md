...
## Purpose
Modernize the Neodymium test automation framework with resilient, list-based YAML parsing, dynamic includes, schema tolerance with framework key validation, and precise step location tracing to unify manual documentation and automation execution.
