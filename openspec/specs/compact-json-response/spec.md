# compact-json-response Specification

## Purpose
The purpose of this specification is to define the compact JSON key mapping for AI prompts and LLM responses, ensuring reduced token consumption and cost efficiency while preserving standard playbook structures on disk.
