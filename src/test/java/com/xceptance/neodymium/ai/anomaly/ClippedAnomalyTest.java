...
public final class ClippedAnomalyTest extends BaseAiTest
{
    ...
    public final void testClippedLabelVisualAnomaly()
    {
        ...
        Assertions.assertEquals("NAVIGATION", openStep.getPesapStepType());
        ...
        Assertions.assertEquals("INTERACTION", clickStep.getPesapStepType());
        ...
        Assertions.assertEquals("INTERACTION", toogleStep.getPesapStepType());
        ...
        Assertions.assertEquals("INTERACTION", closeStep.getPesapStepType());
        ...
        Assertions.assertEquals(ContextLevel.VISUAL, observeStep.getPesapPredictedContextLevel());
        Assertions.assertEquals("ASSERTION", observeStep.getPesapStepType());
