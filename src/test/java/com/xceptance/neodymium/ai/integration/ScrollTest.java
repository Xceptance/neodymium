...
/**
 * Integration test verifying AI scroll commands and their validation flow
...
@Tag("freeform")
public class ScrollTest extends BaseAiTest
{
    private String url;
    ...
    {
        this.url = String.format("http://localhost:%d/ScrollActionTest/testScrollHappyPath.html", server.getPort());
        Neodymium.getData().put("scroll.test.url", this.url);
    }

    /**
     * Test page scrolling with step-by-step verification of status.
     */
    @NeodymiumTest
    public final void testScroll()
    {
        final String steps = """
