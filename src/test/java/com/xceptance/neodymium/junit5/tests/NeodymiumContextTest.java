...
import com.xceptance.neodymium.junit5.testclasses.context.IsSiteTests;
import com.xceptance.neodymium.junit5.testclasses.context.OverrideNeodymiumConfiguration;
...
public class NeodymiumContextTest extends AbstractNeodymiumTest
{
    ...
    public void testIsSite()
    {
        ...
        NeodymiumTestExecutionSummary summary = run(IsSiteTests.class);
    ...
    public void testContextGetCleared() throws Exception
    {
        ...
        NeodymiumTestExecutionSummary summary = run(ContextGetsCleared.class);
    ...
    {
        NeodymiumTestExecutionSummary summary = run(BrowserContextSetup.class);
    ...
    {
        NeodymiumTestExecutionSummary summary = run(DefaultSelenideConfiguration.class);
        checkPass(summary, 2, 0);
    }
    ...
    {
        NeodymiumTestExecutionSummary summary = run(SelenideConfigurationShortcuts.class);
    ...
    {
        NeodymiumTestExecutionSummary summary = run(OverrideNeodymiumConfiguration.class);
        checkPass(summary, 2, 0);
    }
    ...
    {
        Assertions.assertEquals("?.?.?", Neodymium.getNeodymiumVersion());
    }
