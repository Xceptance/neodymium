...
/**
 * Live integration test for the WAIT action plugin.
 *
...
public class WaitIntegrationTest extends BaseAiTest
{
    ...
    /**
     * Executes Wait integration test in both live and strict replay modes.
     *
    ...
    @AiDataSet("waitData")
    public void testWait(final AiSession session)
    {
