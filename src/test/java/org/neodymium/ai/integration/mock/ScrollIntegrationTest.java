...
/**
 * Mock programmatic integration test for the SCROLL action plugin.
 *
...
@Tag("AuraIntegration")
@NeodymiumAiTest
@AiPlaybook(value = "programmatic", name = "custom_scroll_playbook")
public class ScrollIntegrationTest extends BaseAiTest
{
              ...
              "actions": [
                {
                  ...
                  "locator": "",
                  "value": "%s",
                  "reasoning": "Navigate to scroll test page"
                }
              ]
            }
    ...
    public void testScrollMock(final AiSession session) throws Exception
    {
        session.execute( """
            data:
              - testId: scrollData
        ...
        try
        {
            ...
            org.junit.jupiter.api.Assertions.assertTrue(content.contains("\"target\" : \"${scroll.test.url}\""), 
