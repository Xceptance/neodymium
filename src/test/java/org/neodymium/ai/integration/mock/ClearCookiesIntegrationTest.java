...
public class ClearCookiesIntegrationTest extends BaseAiTest
{
    ...
    public void testClearCookiesMock(final AiSession session)
    {
        runPlaybook(session, """
            data:
        ...
        final File recordingFile = new File("src/test/resources/playbooks/integration/programmatic/custom_clear_cookies_playbook.json");
