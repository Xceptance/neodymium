...
/**
 * Mock programmatic integration test for the CLEAR_COOKIES action plugin.
 *
...
@Tag("AuraIntegration")
@NeodymiumAiTest
@AiPlaybook(value = "programmatic", name = "custom_clear_cookies_playbook")
public class ClearCookiesIntegrationTest extends BaseAiTest
{
              ...
              "actions": [
                {
                  ...
                  "locator": "",
                  "value": "",
                  "reasoning": "Clear browser cookies"
                }
              ]
            }
            """, null, "mock"));
    ...
    /**
     * Tests Clear Cookies action.
     *
     * @param session the thread-isolated AiSession
     */
    @AiPlaybook
    @AiMode({ExecutionMode.FORCE_RECORDING, ExecutionMode.REPLAY_STRICT})
    public void testClearCookiesMock(final AiSession session) throws Exception
    {
        session.execute( """
            data:
        ...
        final File recordingFile = new File("src/test/resources/playbooks/integration/programmatic/custom_clear_cookies_playbook_" + browserProfile + ".json");
        ...
        try
        {
            ...
            org.junit.jupiter.api.Assertions.assertTrue(content.contains("\"target\" : \"${clearCookies.test.url}\""), 
