 ...
 * with LLM Quality Judge (second-opinion evaluation) explicitly enabled.
 *
...
{
    /**
     * Constructs a default AddToCartWithJudgeTest.
     */
    public AddToCartWithJudgeTest()
    {
    }

    /**
     * Setup method to inject dynamic server URLs and enable Quality Judge.
     */
    @BeforeEach
    public void setup()
    {
