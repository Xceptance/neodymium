...
/**
 * English Language Guest Checkout Integration Test targeting the Modern Bad UI (with WCAG) US storefront (/verla-modern-bad/).
...
@Tag("LiveAPI")
@NeodymiumAiTest
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_Us_English_ModernBad.yaml", recordingDirectory = "target/playbooks/integration")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaGuestCheckout_Us_English_ModernBad extends BaseAiTest
{
    /**
     * Constructs a default VerlaGuestCheckout_Us_English_ModernBad instance.
     */
    public VerlaGuestCheckout_Us_English_ModernBad()
    {
    }
