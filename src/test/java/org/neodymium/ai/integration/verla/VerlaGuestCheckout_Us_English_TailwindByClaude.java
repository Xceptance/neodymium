...
/**
 * English Language Guest Checkout Integration Test targeting the Strict Utility-First Tailwind US storefront (/verla-tailwind-by-claude/).
...
@Tag("LiveAPI")
@NeodymiumAiTest
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_Us_English_TailwindByClaude.yaml", recordingDirectory = "target/playbooks/integration")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaGuestCheckout_Us_English_TailwindByClaude extends BaseAiTest
{
    /**
     * Constructs a default VerlaGuestCheckout_Us_English_TailwindByClaude instance.
     */
    public VerlaGuestCheckout_Us_English_TailwindByClaude()
    {
    }
