...
/**
 * Polish Language Guest Checkout Integration Test targeting the Poland storefront (-PL).
 * Drives the Polish Verla SUT checkout flow using natural Polish step instructions.
 *
...
{
    /**
     * Constructs a default VerlaGuestCheckout_Pl_Polish instance.
     */
    public VerlaGuestCheckout_Pl_Polish()
    {
    }
