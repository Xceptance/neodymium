...
/**
 * Swedish Language Guest Checkout Integration Test targeting the Sweden storefront (-SE).
 * Drives the Swedish Verla SUT checkout flow using natural Swedish step instructions.
 *
...
@Tag("LiveAPI")
@NeodymiumAiTest
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_Se_Swedish.yaml", recordingDirectory = "target/playbooks/integration")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaGuestCheckout_Se_Swedish extends BaseAiTest
{
    /**
     * Constructs a default VerlaGuestCheckout_Se_Swedish instance.
     */
    public VerlaGuestCheckout_Se_Swedish()
    {
    }
