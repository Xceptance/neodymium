...
/**
 * English Language Guest Checkout Integration Test targeting the Tailwind CSS US storefront (/verla-tailwind/).
...
@Tag("LiveAPI")
@NeodymiumAiTest
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_Us_English_Tailwind.yaml", recordingDirectory = "target/playbooks/integration")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaGuestCheckout_Us_English_Tailwind extends BaseAiTest
{
    /**
     * Constructs a default VerlaGuestCheckout_Us_English_Tailwind instance.
     */
    public VerlaGuestCheckout_Us_English_Tailwind()
    {
    }
