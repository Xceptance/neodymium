...
/**
 * Runs YAML-based VERLA integration tests for adding items to cart and applying coupons
 * with LLM Quality Judge, Semantic Outcome Verification, and Visual Root Cause Analysis (RCA) explicitly enabled.
 *
...
{
    /**
     * Constructs a default AddToCartJudgeAndVerificationsTest.
     */
    public AddToCartJudgeAndVerificationsTest()
    {
    }

    /**
     * Setup method to inject dynamic server URLs and enable Judge, Semantic Verification, and Visual RCA.
     */
    @BeforeEach
    public void setup()
    {
