...
/**
 * English Language Guest Checkout Integration Test targeting the Modern Bad UI (without WCAG) US storefront (/verla-modern-bad-nowcag/).
...
@Tag("LiveAPI")
@NeodymiumAiTest
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_Us_English_ModernBadNoWcag.yaml", recordingDirectory = "target/playbooks/integration")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaGuestCheckout_Us_English_ModernBadNoWcag extends BaseAiTest
{
    /**
     * Constructs a default VerlaGuestCheckout_Us_English_ModernBadNoWcag instance.
     */
    public VerlaGuestCheckout_Us_English_ModernBadNoWcag()
    {
    }
