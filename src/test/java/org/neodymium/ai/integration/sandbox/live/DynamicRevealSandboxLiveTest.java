...
/**
 * Live LLM integration test for the Dynamic Reveal sandbox challenge.
...
@Tag("LiveLlm")
@NeodymiumAiTest
@AiPlaybook(value = "programmatic", recordingFileName = "live_dynamic_reveal_playbook")
public class DynamicRevealSandboxLiveTest extends BaseAiTest
{
    ...
    /**
     * Tests dynamic reveal challenge using live LLM across 3 execution modes.
     *
     * @param session the thread-isolated AiSession
     */
    @AiPlaybook
