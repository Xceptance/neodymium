...
/**
 * Live LLM integration test for the Floating Labels sandbox challenge.
...
@Tag("LiveLlm")
@NeodymiumAiTest
@AiPlaybook(value = "programmatic", recordingFileName = "live_floating_labels_playbook")
public class FloatingLabelsSandboxLiveTest extends BaseAiTest
{
    ...
    /**
     * Tests floating labels challenge using live LLM across 3 execution modes.
     *
     * @param session the thread-isolated AiSession
     */
    @AiPlaybook
    ...
    public void testFloatingLabelsLive(final AiSession session)
    {
        runPlaybook(session, """
            steps: |
              ...
              Click the fix button to trigger the floating label transition
