        ...
        function filterSettingsProperties(query) {
            ...
            // 1. Filter individual property rows
            ...
            // 2. Hide sub-headline sections that have no visible property rows
            ...
            // 3. Hide property group cards that have no visible sections or devNeo rows
            document.querySelectorAll('.settings-group-card').forEach(card => {
                ...
                if (visibleSections.length > 0 || visibleDevNeo.length > 0) {
                    card.style.display = 'block';
                    // Auto-expand card content when searching
                    const content = card.querySelector('.settings-group-content');
        ...
        function removeDevNeoRow(btnElem) {
            ...
            if (container.querySelectorAll('.dev-neo-row').length > 1) {
                ...
                row.querySelector('.dev-neo-key-input').value = '';
                row.querySelector('.dev-neo-val-input').value = '';
            }
        }
