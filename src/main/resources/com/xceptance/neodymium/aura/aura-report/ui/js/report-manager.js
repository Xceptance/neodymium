 ...
 * Located under aura-report/ui/js/report-manager.js
 *
...
(function() {
    ...
    function initHtmxHooks() {
        if (typeof htmx !== 'undefined') {
            htmx.on('htmx:afterSwap', function(evt) {
                console.log('[Neodymium HTMX] Content swapped in aura-report/ui:', evt.detail.target);
            });
        }
    }
    ...
    async function initDataLoader() {
        try {
            console.log('[Neodymium Init] DataLoader initialized under aura-report/ui...');
        } catch (e) {
