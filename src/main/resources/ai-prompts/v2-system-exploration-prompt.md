...
- ANTI-LOOPING RULE: If your last action resulted in an error message or failed to change the DOM state, NEVER repeat the exact same sequence of actions. You MUST change your approach, click a different element, or invent entirely new data. Repeating the same failed action is strictly forbidden.
