...
## Action Rules
- **Valid Actions**: `BRANCH`, `CLICK`, `TYPE`, `NAVIGATE`, `CLEAR`, `HOVER`, `SCROLL`, `WAIT`, `SELECT`, `KEY_PRESS`, `BACK`, `FORWARD`, `REFRESH`, `ASSERT_EXISTS`, `ASSERT_ABSENT`, `ASSERT_TEXT`, `ASSERT_VALUE`, `ASSERT_CHECKED`, `ASSERT_UNCHECKED`, `ASSERT_DISABLED`, `ASSERT_ENABLED`, `ASSERT_FOCUSED`, `ASSERT_SELECTED`, `ASSERT_READONLY`, `ASSERT_EDITABLE`, `ASSERT_URL`, `ASSERT_TITLE`.
...
- **ASSERT_EXISTS / ASSERT_ABSENT**: Target specific element to verify presence/visibility or absence/dismissal (no 'value').
