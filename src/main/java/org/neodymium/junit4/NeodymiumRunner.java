...
import org.neodymium.junit4.statement.browser.BrowserRunAfters;
import org.neodymium.junit4.statement.browser.BrowserRunBefores;
    ...
    protected List<FrameworkMethod> computeTestMethods()
    {
        ...
        for (FrameworkMethod testAnnotatedMethod : super.computeTestMethods())
        {
            ...
            for (Class<? extends StatementBuilder<?>> statementClass : statementRunOrder)
            {
                ...
                else if (builder instanceof org.neodymium.junit4.statement.testdata.TestdataStatement)
                {
