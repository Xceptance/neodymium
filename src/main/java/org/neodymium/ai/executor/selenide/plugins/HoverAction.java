 ...
 */
public final class HoverAction implements BrowserActionPlugin
{
    /**
     * Constructs a HoverAction.
     */
    public HoverAction()
    {
    }
    ...
    /**
     * Hovers mouse over the target element.
     *
     * @param action the hover action
     * @throws Exception if hover fails
     */
    @Override
