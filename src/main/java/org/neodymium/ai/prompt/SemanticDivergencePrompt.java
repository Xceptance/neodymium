...
public final class SemanticDivergencePrompt implements AiPrompt<String>
{
    ...
    {
        return "You are an expert QA automation assistant. Your job is to compare a baseline web page source (the expected state) with the current web page source (the actual state) to identify semantic differences, such as elements being renamed, ID changes, or layout updates. Output only a concise, plain-English summary of the changes detected. Do not write HTML, code, or generic descriptions.";
    }
