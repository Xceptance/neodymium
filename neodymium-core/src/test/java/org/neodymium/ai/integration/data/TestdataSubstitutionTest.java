...
/**
 * Integration test verifying intra-dataset variable interpolation and nested dot-path resolution
 * in an inline programmatic YAML playbook running against the local embedded HTML server.
 *
...
@NeodymiumAiTest
public class TestdataSubstitutionTest extends BaseAiTest
{
    @BeforeAll
    ...
    /**
     * Executes programmatic steps using inline dataset with intra-dataset variable interpolation.
     *
