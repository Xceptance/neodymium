...
/**
 * French Canadian Guest Checkout Integration Test targeting the Canada French storefront (-CA-FR) using French instructions.
 *
...
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_CaFr_French.yaml", recordingDirectory = "target/playbooks/integration/checkout/i18n/ca")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaCaFrFrenchBasicCheckoutTest extends BaseAiTest
{
    /**
     * Constructs a default VerlaCaFrFrenchBasicCheckoutTest instance.
     */
    public VerlaCaFrFrenchBasicCheckoutTest()
    {
    }
