...
/**
 * Mock programmatic integration test for the REFRESH action plugin.
 *
...
@Tag("AuraIntegration")
@NeodymiumAiTest
@AiPlaybook(value = "programmatic", name = "custom_refresh_playbook")
public class RefreshIntegrationTest extends BaseAiTest
{
    ...
    /**
     * Tests Refresh action.
     *
     * @param session the thread-isolated AiSession
     */
    @AiPlaybook
    @AiMode({ExecutionMode.FORCE_RECORDING, ExecutionMode.REPLAY_STRICT})
    public void testRefreshMock(final AiSession session) throws Exception
    {
        session.execute( """
            data:
              - testId: refreshData
        ...
        final File recordingFile = new File("src/test/resources/playbooks/integration/programmatic/custom_refresh_playbook_" + browserProfile + ".json");
        ...
        try
        {
            ...
            org.junit.jupiter.api.Assertions.assertTrue(content.contains("\"target\" : \"${refresh.test.url}\""), 
