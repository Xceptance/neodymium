...
/**
 * English Language Guest Checkout Integration Test targeting the United Kingdom storefront (-UK).
 * Drives the English multi-locale playbook for United Kingdom.
 *
...
{
    /**
     * Constructs a default VerlaGuestCheckout_Uk_English instance.
     */
    public VerlaGuestCheckout_Uk_English()
    {
    }
