...
/**
 * German Language Guest Checkout Integration Test targeting the Germany storefront (-DE).
 * Drives the German Verla SUT checkout flow using natural German step instructions.
 *
...
@Tag("LiveAPI")
@NeodymiumAiTest
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_De_German.yaml", recordingDirectory = "target/playbooks/integration")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaGuestCheckout_De_German extends BaseAiTest
{
    /**
     * Constructs a default VerlaGuestCheckout_De_German instance.
     */
    public VerlaGuestCheckout_De_German()
    {
    }
