 ...
 */
package org.neodymium.ai.integration.verla.cart.full;
...
/**
 * Combined Quality Judge and Outcome Verification Add to Cart and Coupon Integration Test across multiple storefront datasets.
 *
...
@AiPlaybook(value = "/verla/AddToCartTest.yaml", recordingDirectory = "target/playbooks/integration/cart")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class CartTest extends BaseAiTest
{
    /**
     * Constructs a default CartTest instance.
     */
    public CartTest()
    {
    }
    ...
    @AiDataSet("perfect")
    @AiPlaybook(value = "/verla/AddToCartTest.yaml", recordingMethod = "livePerfect")
    ...
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiDataSet("normal")
    @AiPlaybook(value = "/verla/AddToCartTest.yaml", recordingMethod = "liveNormal")
    ...
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiDataSet("bad")
    @AiPlaybook(value = "/verla/AddToCartTest.yaml", recordingMethod = "liveBad")
    ...
    @Order(8)
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiPlaybook(value = "/verla/AddToCartTest.yaml", recordingMethod = "liveAllDataSets")
