...
/**
 * English Language Guest Checkout Integration Test targeting the Finland storefront (-FI).
 * Drives the English multi-locale playbook for Finland.
 *
...
{
    /**
     * Constructs a default VerlaGuestCheckout_Fi_English instance.
     */
    public VerlaGuestCheckout_Fi_English()
    {
    }
