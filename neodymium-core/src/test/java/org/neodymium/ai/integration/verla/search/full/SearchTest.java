 ...
 */
package org.neodymium.ai.integration.verla.search.full;
...
/**
 * Combined Quality Judge and Outcome Verification Product Search and Filtering Integration Test across multiple storefront datasets.
 *
...
@AiPlaybook(value = "/verla/SearchTest.yaml", recordingDirectory = "target/playbooks/integration/search")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class SearchTest extends BaseAiTest
{
    /**
     * Constructs a default SearchTest instance.
     */
    public SearchTest()
    {
    }
    ...
    @AiDataSet("perfect")
    @AiPlaybook(value = "/verla/SearchTest.yaml", recordingMethod = "livePerfect")
    ...
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiDataSet("normal")
    @AiPlaybook(value = "/verla/SearchTest.yaml", recordingMethod = "liveNormal")
    ...
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiDataSet("bad")
    @AiPlaybook(value = "/verla/SearchTest.yaml", recordingMethod = "liveBad")
    ...
    @Order(8)
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiPlaybook(value = "/verla/SearchTest.yaml", recordingMethod = "liveAllDataSets")
