...
/**
 * German Language Guest Checkout Integration Test targeting the US storefront (-US) using German instructions.
 *
...
@AiPlaybook(value = "playbooks/integration/VerlaGuestCheckout_Us_German.yaml", recordingDirectory = "target/playbooks/integration/checkout/i18n/us")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class VerlaUsGermanBasicCheckoutTest extends BaseAiTest
{
    /**
     * Constructs a default VerlaUsGermanBasicCheckoutTest instance.
     */
    public VerlaUsGermanBasicCheckoutTest()
    {
    }
