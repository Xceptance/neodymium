...
public class VerlaBasicSearchGermanTest extends BaseAiTest
{
    /**
     * Constructs a default VerlaBasicSearchGermanTest instance.
     */
    public VerlaBasicSearchGermanTest()
    {
    }
    ...
    @AiDataSet("perfect")
    @AiPlaybook
    public void testSearchLiveGerman()
    {
    }
    ...
    @AiDataSet("perfect")
    @AiPlaybook(recordingMethod = "testSearchLiveGerman")
    public void testSearchReplayGerman()
    {
    }
}
