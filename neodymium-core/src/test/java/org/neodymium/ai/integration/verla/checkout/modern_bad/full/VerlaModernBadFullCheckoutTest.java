 ...
 */
package org.neodymium.ai.integration.verla.checkout.modern_bad.full;
...
/**
 * Combined Quality Judge and Outcome Verification Guest Checkout Integration Test targeting the Modern Bad UI US storefront (/verla-modern-bad/) in live recording and strict replay modes with both Quality Judge and Semantic Outcome Verification enabled.
 *
...
public class VerlaModernBadFullCheckoutTest extends BaseAiTest
{
    /**
     * Constructs a default VerlaModernBadFullCheckoutTest instance.
     */
    public VerlaModernBadFullCheckoutTest()
    {
    }
