 ...
 */
package org.neodymium.ai.integration.verla.homepage.outcome;
...
/**
 * Outcome Verification Homepage Navigation and Layout Verification Integration Test across multiple storefront datasets with Semantic Outcome Verification enabled.
 *
...
{
    /**
     * Constructs a default HomepageTest instance.
     */
    public HomepageTest()
    {
    }
    ...
    @AiDataSet("perfect")
    @AiPlaybook(value = "verla/HomepageTest.yaml", recordingMethod = "livePerfect")
    ...
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiDataSet("normal")
    @AiPlaybook(value = "verla/HomepageTest.yaml", recordingMethod = "liveNormal")
    ...
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiDataSet("bad")
    @AiPlaybook(value = "verla/HomepageTest.yaml", recordingMethod = "liveBad")
    ...
    @Order(8)
    @AiMode(ExecutionMode.REPLAY_STRICT)
    @AiPlaybook(value = "verla/HomepageTest.yaml", recordingMethod = "liveAllDataSets")
