...
public class ContextLevelTest
{
    ...
    @Test
    public void testCleanContextLevel()
    {
        Assertions.assertEquals(ContextLevel.LEAN, ContextLevel.clean(null));
        Assertions.assertEquals(ContextLevel.MINIMAL, ContextLevel.clean(ContextLevel.MINIMAL));
        Assertions.assertEquals(ContextLevel.LEAN, ContextLevel.clean(ContextLevel.LEAN));
        Assertions.assertEquals(ContextLevel.HINT, ContextLevel.clean(ContextLevel.HINT));
        Assertions.assertEquals(ContextLevel.STANDARD, ContextLevel.clean(ContextLevel.STANDARD));
        Assertions.assertEquals(ContextLevel.RICH, ContextLevel.clean(ContextLevel.RICH));
        Assertions.assertEquals(ContextLevel.VISUAL, ContextLevel.clean(ContextLevel.VISUAL));
        Assertions.assertEquals(ContextLevel.VISUAL_LEAN, ContextLevel.clean(ContextLevel.VISUAL_LEAN));
        Assertions.assertEquals(ContextLevel.VISUAL_RICH, ContextLevel.clean(ContextLevel.VISUAL_RICH));
    }

    @Test
    public void testCleanStringOverloadWithFallbacks()
    {
        // Unparseable/null strings with fallback
        Assertions.assertEquals(ContextLevel.STANDARD, ContextLevel.clean("invalid_level", ContextLevel.STANDARD));
        Assertions.assertEquals(ContextLevel.RICH, ContextLevel.clean((String) null, ContextLevel.RICH));
        Assertions.assertEquals(ContextLevel.LEAN, ContextLevel.clean("", null));

        // Valid strings
        Assertions.assertEquals(ContextLevel.STANDARD, ContextLevel.clean("standard", null));
        Assertions.assertEquals(ContextLevel.RICH, ContextLevel.clean("RICH", null));
        Assertions.assertEquals(ContextLevel.VISUAL, ContextLevel.clean("  visual  ", null));
    }
}
