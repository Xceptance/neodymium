...
public class OpenAiLlmProviderTest
{
    ...
    public void setUp()
    {
        this.previousKey = System.getProperty("neodymium.ai.openai.apiKey");
    }
    ...
    public void tearDown()
    {
        ...
        {
            System.setProperty("neodymium.ai.openai.apiKey", this.previousKey);
        }
        else
        {
    ...
    {
        System.setProperty("neodymium.ai.openai.apiKey", "mock-openai-key");
        final OpenAiLlmProvider provider = new OpenAiLlmProvider();
    ...
    {
        System.setProperty("neodymium.ai.openai.apiKey", "");
        System.setProperty("neodymium.ai.apiKey", "");
        AiConfiguration.resetInstance();
        final String envKey = System.getenv("OPENAI_API_KEY");
