...
<body>
        ...
        <div class="column">
            <div class="scrollable-content" id="timelineList">
                ...
                <div class="block-group" id="beforeGroup">
                    ...
                    <div class="step-card include-lvl-1">
                        ...
                        <div class="step-accordion-details">
                            ...
                            <!-- LLM Actions List instead of webdriver code -->
                            <div class="llm-action-list">
                                <div class="llm-action-item success">
                                    <i class="fa-solid fa-arrow-pointer llm-action-icon"></i>
                                    <span class="llm-action-desc">Click <span class="llm-action-target">#login-btn</span></span>
                                    <i class="fa-solid fa-check llm-action-status"></i>
                                </div>
                                <div class="llm-action-item success">
                                    <i class="fa-solid fa-hourglass-half llm-action-icon"></i>
                                    <span class="llm-action-desc">Wait for visibility of <span class="llm-action-target">#login-form</span></span>
                                    <i class="fa-solid fa-check llm-action-status"></i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="block-group" id="stepsGroup">
                    ...
                    <!-- Failed Step Mock -->
                    <div class="step-card include-lvl-1" style="border-color: var(--accent-danger);">
                        <div class="step-row">
                        ...
                        <div class="step-accordion-details open">
                            ...
                            <div class="llm-action-list">
                                <div class="llm-action-item success">
                                    <i class="fa-solid fa-magnifying-glass llm-action-icon"></i>
                                    <span class="llm-action-desc">Find <span class="llm-action-target">.checkout-action-button</span></span>
                                    <i class="fa-solid fa-check llm-action-status"></i>
                                </div>
                                <div class="llm-action-item failed">
                                    <i class="fa-solid fa-arrow-pointer llm-action-icon"></i>
                                    <span class="llm-action-desc">Click <span class="llm-action-target">.checkout-action-button</span></span>
                                    <i class="fa-solid fa-xmark llm-action-status"></i>
                                </div>
                                <div style="font-size: 12px; color: var(--accent-danger); padding: 4px 10px;">ElementNotInteractableException: Element is obscured by overlay.</div>
                            </div>
                        </div>
                    </div>

                    <!-- ACTIVE Running Step -->
                    <div class="step-card active include-lvl-3">
                        <div class="step-row">
                        ...
                        <div class="step-accordion-details open">
                            ...
                            <div class="llm-action-list">
                                ...
                                <div class="llm-action-item pending">
                                    ...
                                    <i class="fa-solid fa-spinner fa-spin llm-action-status"></i>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function toggleAccordion(textElement) {
            // Prevent toggle if currently editing
        ...
        function enableEdit(btnElement) {
            ...
            // Expand accordion so user can see context while editing
            const acc = card.querySelector('.step-accordion-details');
        ...
        function saveEdit(btnElement) {
            ...
            console.log("Saved new step text:", textarea.value);
            // Here you would trigger backend sync via postMessage
        }
